...
const services = [
  ...
  { title: "IT Consulting & Strategy", description: "Expert consulting for IT infrastructure, digital transformation,  and project management." },
  { title: "Web Development & Design", description: "Website development, UI/UX design, e-commerce solutions, and CMS platforms like WordPress." },
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg">
              <p className="italic">"Prasunet transformed our business with an outstanding AI-driven application."</p>
              <h4 className="mt-4 font-bold">- John Doe, CEO of TechCorp</h4>
            </div>
            <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg">
              <p className="italic">"Their cybersecurity services have made our data more secure than ever before."</p>
