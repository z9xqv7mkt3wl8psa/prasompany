            ...
            const verifyToken = async () => {
                try {
                    ...
                    if (!querySnapshot.empty) {
                        ...
                        const fullDocData = certificateDoc.data();

                        const certificateData: CertificateData = {
                            fullName: fullDocData?.fullName || '',
                            collegeName: fullDocData?.collegeName || '',
                            domainOfInternship: fullDocData?.domainOfInternship || '',
                            fatherName: fullDocData?.fatherName || '',
                            gender: fullDocData?.gender || '',
                            internId: fullDocData?.internId || '',
                            internshipDuration: fullDocData?.internshipDuration || '',
                            typeOfInternship: fullDocData?.typeOfInternship || '',
                            assignedProject: fullDocData?.assignedProject || '',
                            token: fullDocData?.token || ''
                        };
