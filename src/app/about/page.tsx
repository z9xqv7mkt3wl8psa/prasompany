  ...
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-20 lg:px-24 md:py-16 md:px-12 py-12 px-6">
      ...
      <section className="lg:w-10/12 w-full text-center mx-auto">
        <p className="text-indigo-700 text-2xl font-semibold uppercase">About Us</p>
      ...
      <section className="lg:mt-14 sm:mt-10 mt-12">
        <img className="w-full rounded-lg shadow-lg" src="https://i.ibb.co/GvwJnvn/Group-736.png" alt="Group of people Chilling" loading="lazy" />
      </section>
