        ...
        <div className="hidden md:block">
          <section className="w-full py-16 flex flex-col md:flex-row items-center justify-center gap-10 px-6 bg-gray-100 relative">
            ...
            <div className="relative w-full md:w-2/5 flex justify-end">
              <div className="relative w-[450px] h-[500px] overflow-hidden rounded-lg shadow-lg">
                <Image 
              ...
              <div className="absolute left-[-80px] top-1/2 transform -translate-y-1/2 w-[280px] h-[280px] rounded-full overflow-hidden border-4 border-white shadow-xl">
